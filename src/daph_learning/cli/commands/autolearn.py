...
def main() -> None:
    ...
    output = {
        ...
        # v0.3.8.1: explicit termination reason so a stopped run can be
        # triaged instead of mislabelled "converged".
        ...
        "learning_curve": [
            {
                ...
                "updated": m.updated,
                # v0.3.8.1: activation-capture coverage telemetry.
    ...
    print("\nLearning curve:")
    print(f"{'iter':>4} {'train_acc':>10} {'val_f1':>10} {'val_acc':>10} {'updated':>8} {'|v|':>10} {'cap_cov':>8}")
    for m in result.iterations:
        print(f"{m.iteration:4d} {m.train_accuracy:10.4f} {m.val_f1:10.4f} {m.val_accuracy:10.4f} {str(m.updated):>8} {m.vector_norm:10.4f} {m.capture_coverage:8.3f}")
