# DAPH AutoLearn v0.4.0a2 — Licensed Claims
...
The main repository contains 1597 collected tests in the release build
(collected on macOS Darwin 25.2.0, Python 3.12.0, pytest 8.4.2; 1513 passed,
